 ...
 *
 */
public class AdminBasedAccessInterceptor extends HandlerInterceptorAdapter {
	...
	public void postHandle(HttpServletRequest request,
		...
		System.out.println(" PostHandle method for "
	...
	public void afterCompletion(HttpServletRequest request,
		...
		System.out.println("AfterCompletion method for "
				+ request.getRequestURI().toString());
